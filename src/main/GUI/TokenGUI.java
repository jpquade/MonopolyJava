...
public class TokenGUI {
    ...
    public TokenGUI(JLayeredPane rLayeredPane) throws IOException {
        ...
        tokenImageSrc = new ArrayList<>(Arrays.asList("src/main/MonopolyImages/Tokens/car.png", "src/main/MonopolyImages/Tokens/cat.png",
                "src/main/MonopolyImages/Tokens/dog.png", "src/main/MonopolyImages/Tokens/hat.png", "src/main/MonopolyImages/Tokens/iron.png",
                "src/main/MonopolyImages/Tokens/ship.png", "src/main/MonopolyImages/Tokens/shoe.png", "src/main/MonopolyImages/Tokens/thimble.png"));
