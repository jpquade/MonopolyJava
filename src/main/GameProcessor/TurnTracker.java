...
public class TurnTracker {
    ...
    private final PlayerProcessor players;
    ...
    public TurnTracker() throws FileNotFoundException {
        this.players = new PlayerProcessor();
        ...
        dice = new Dice();
        moneyProcessor = new MoneyProcessor(players, new TransactionHistoryGUI(), new CommandBoxGUI());
